  ...
  describe('User and Comment models functionality works', () => {
    ...
    describe('Comments model', () => {
      ...
      it('can create a new comment in our db', async () => {
        const postContent =
          "Hey, I can't believe that launch failed. Is there anywhere I can read more comprehensive data regarding the launch?"
      ...
      it('can be updated', () => {
        return testComment
          .update({
            post:
              'Oh wow, the rocket is resuable. This will reduce the cost of space travel drastically'
          })
          .then(updatedPost => {
